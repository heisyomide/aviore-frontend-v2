        ...
        >
          ...
          >
            <div className="space-y-1">
              ...
              <h2 className="text-xl md:text-2xl font-black text-gray-900 uppercase italic tracking-tight leading-none">
                Order Summary
              </h2>
            ...
            <button
              onClick={onClose}
              className="h-11 w-11 rounded-full bg-zinc-100 hover:bg-[#A4143D] hover:text-white transition-all duration-300 flex items-center justify-center active:scale-95"
            >
              <X size={18} />
            </button>
          </div>
