...
export function CategoryMegaMenu() {
  ...
  return (
    <div className="relative group">
      ...
      {/* TRIGGER */}
      <button className="flex items-center gap-2 py-5 text-[13px] font-black uppercase tracking-wider text-black hover:text-[#A4143D] transition-all">
        ...
        <div className="w-[260px] bg-gray-50/50 border-r border-gray-100 p-3">
          ...
          {MARKETPLACE_CATEGORIES.map((category) => (
            <button
              ...
              className={`
                w-full text-left px-5 py-4 rounded-2xl mb-2 transition-all flex items-center justify-between
        ...
        <div className="flex-1 flex flex-col h-[620px]">
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      {group.children.map((item) => (
                        ...
                        >
                          ...
                          {/* ICON */}
                          <div className="relative w-11 h-11 rounded-xl overflow-hidden bg-gray-50 border border-gray-100 shrink-0 group-hover/item:border-[#A4143D]/30" />
          ...
          <div className="p-6 bg-gray-50/50 border-t border-gray-100">
            ...
            <Link
              ...
              className="relative w-full h-32 rounded-3xl overflow-hidden group flex items-center bg-black shadow-lg"
            >
